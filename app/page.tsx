...
function RightTabMenu() {
  return (
    <div className="flex flex-col gap-4 font-Noto w-1/4  border-r-zinc-600 border-r-2 justify-start pr-2 md:pr-8 items-end relative">
      <div className="flex flex-col gap-4 w-18 md:w-48 h-full">
        ...
        <div className="flex gap-4 justify-left items-center rounded-full hover:bg-slate-100 p-2 px-6">
          ...
          <Link href="/" className="text-2xl font-bold font-Nunito text-black">
            ホーム
          </Link>
        </div>
      ...
      <div className="flex flex-col items-center gap-4 absolute bottom-0">
        <LoginButton />
      </div>
    </div>
  );
